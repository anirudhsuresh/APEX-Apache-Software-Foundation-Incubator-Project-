...
call_table_commits()
function call_table_commits() {
var column_names = ["URL","Actual Date Time","Receiver Email"];
// var column_names = ["Title","Views","Time","URL","Next boy"];0
var clicks = {title: 0, views: 0, created_on: 0, url: 0};

// draw the table
d3v3.select(".popman1").append("div")
  .attr("id", "c1")

d3v3.select("#c1").append("div")
...
d3v3.csv("james m snell.csv", function(error, data) {
  console.log(data)
  ...
  row_entries_with_anchor
    ...
    // .attr("target", "_blank")
    .attr("id", "1")
    .attr("onclick","window.open(this.href, 'newwindow','width=500,height=450');return false;")
    // .attr("return false;")
    // .attr("target", "_blank")
  .text('Link')
  // .text(function(d) { return d; })
